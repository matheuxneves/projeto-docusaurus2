...
description: Guia rápido para utilização do calendário de preços, abordando tarifas, disponibilidade e funcionalidades do sistema.
...
- *Aberto para Vendas*  
- *Fechado para Vendas*  
- *Fechado Parcialmente para Vendas*  
- *Allotment Indisponível*

Essas legendas aparecerão no calendário de preços.
...
Será possível editar os detalhes da tarifa ou tipo de quarto para seguir com as atualizações de:
