```markdown
---
sidebar_label: TARIFÁRIOS E DISPONIBILIDADE CALENDÁRIO DE PREÇOS GUIA RÁPIDO
title: TARIFÁRIOS E DISPONIBILIDADE CALENDÁRIO DE PREÇOS GUIA RÁPIDO
description: Guia rápido para entender as funcionalidades do calendário de preços- incluindo tarifas- pacotes e visualização.
...
Exibirá um calendário que possibilita visualizar até 6 meses.
...
**AO PASSAR O MOUSE SOBRE UM DIA DO CALENDÁRIO, APARECERÁ TAMBÉM O BOTÃO ‘EDITAR’ (SINALIZADO POR UM ÍCONE EM FORMATO DE LÁPIS) NO CANTO SUPERIOR DIREITO DO QUADRADO DO DIA. SERÁ POSSÍVEL CLICAR EM ‘EDITAR’, ‘FECHAR ESTE(S) DIA(S)’ E ‘ABRIR ESTE(S) DIA(S)’:**
