...
description: Guia detalhado sobre tarifas, disponibilidade e funcionalidades do calendário de preços do sistema.
slug: /
---
...
![imagem-1](/assets/guia-myhotel-calendario-de-precos-teste-3/imagem-1.webp)
...
Para visualizar estas informações, é necessário selecionar um ‘tipo de quarto’ do tarifário cujas informações você deseja consultar.  

É importante que você conheça as opções de pesquisa e os filtros disponíveis, que podem ajudar a encontrar as informações desejadas de maneira mais rápida. Veja:  
...
• Para seguir com as atualizações de:  
